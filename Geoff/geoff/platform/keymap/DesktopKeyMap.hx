 ...
 * @author Simon
 */
@:buildXml("<files id='haxe'><compilerflag value='-I${haxelib:geoff}/../template/common/cpp/glfw_base/include'/></files>")
...
extern class DesktopKeyMap
{
	...
	public static var GRAVE_ACCENT : Int;  /* ` */
	...
	public static var NUMPAD_EQUAL : Int;
